...
function redraw() {
  ...
  // Draw shadow :snoopy
  if (jumping) {
	drawEllipse(x + 220, y + 320, 100 - breathAmt, 4);
  } else {
	drawEllipse(x + 220, y + 320, 150 - breathAmt, 6);
  }
  
  // Draw shadow : bird
  if (jumping) {
	drawEllipse(x + 85, y + 320, 15 - breathAmt, 3);
  } else {
	drawEllipse(x + 85, y + 320, 30 - breathAmt, 5);
  }
  ...
  context.drawImage(images["body_whole"], x + 100, y + 50);

  drawEllipse(x + 180, y + 96 - breathAmt, 8, curEyeHeight, curEyeColor); 
  // Left Eye
  drawEllipse(x + 200, y + 96 - breathAmt, 8, curEyeHeight, curEyeColor); 
  // Right Eye

  context.drawImage(images["bird"], x + 50, y + 170);	
